...
const ARVENSES_NOBLES: ArvenseItem[] = [
  {
    id: 'hyptis_atrorubens',
    nombre: 'Hyptis atrorubens',
    nombreCientifico: <em>Hyptis atrorubens</em>,
    image: 'hyptis_atrorubens.png',
  },
  {
    id: 'spermacoce_alata',
    nombre: 'Spermacoce alata',
    nombreCientifico: <em>Spermacoce alata</em>,
    image: 'spermacoce_alata.png',
  },
  {
    id: 'drymaria_cordata',
    nombre: 'Drymaria cordata',
    nombreCientifico: <em>Drymaria cordata</em>,
    image: 'drymaria_cordata.png',
  },
  {
    id: 'grona_adscendens',
    nombre: 'Grona adscendens',
    nombreCientifico: (
      <>
        <em>Grona adscendens</em> (antes <em>Desmodium ovalifolium</em>)
      </>
    ),
    image: 'grona_adscendens.png',
  },
  {
    id: 'synedrella_nodiflora',
    nombre: 'Synedrella nodiflora',
    nombreCientifico: <em>Synedrella nodiflora</em>,
    image: 'synedrella_nodiflora.png',
  },
  {
    id: 'arachis_pintoi',
    nombre: 'Arachis pintoi',
    nombreCientifico: <em>Arachis pintoi</em>,
    image: 'arachis_pintoi.png',
  },
  {
    id: 'dichondra_repens',
    nombre: 'Dichondra repens',
    nombreCientifico: <em>Dichondra repens</em>,
    image: 'dichondra_repens.png',
  },
  {
    id: 'euphorbia_hirta',
    nombre: 'Euphorbia hirta',
    nombreCientifico: <em>Euphorbia hirta</em>,
    image: 'euphorbia_hirta.png',
  },
  {
    id: 'pseudoelephantopus_spicatus',
    nombre: 'Pseudoelephantopus spicatus',
    nombreCientifico: <em>Pseudoelephantopus spicatus</em>,
    image: 'pseudoelephantopus_spicatus.png',
  },
];
...
const ARVENSES_AGRESIVAS: ArvenseItem[] = [
  {
    id: 'setaria_palmifolia',
    nombre: 'Setaria palmifolia',
    nombreCientifico: <em>Setaria palmifolia</em>,
    image: 'setaria_palmifolia.png',
  },
  {
    id: 'oxalis_latifolia',
    nombre: 'Oxalis latifolia',
    nombreCientifico: <em>Oxalis latifolia</em>,
    image: 'oxalis_latifolia.png',
  },
  {
    id: 'paspalum_dilatatum',
    nombre: 'Paspalum dilatatum',
    nombreCientifico: <em>Paspalum dilatatum</em>,
    image: 'paspalum_dilatatum.png',
  },
  {
    id: 'sorghum_halepense',
    nombre: 'Sorghum halepense',
    nombreCientifico: <em>Sorghum halepense</em>,
    image: 'sorghum_halepense.png',
  },
  {
    id: 'digitaria_sanguinalis',
    nombre: 'Digitaria sanguinalis',
    nombreCientifico: <em>Digitaria sanguinalis</em>,
    image: 'digitaria_sanguinalis.png',
  },
  {
    id: 'cyperus_brevifolius',
    nombre: 'Cyperus brevifolius',
    nombreCientifico: <em>Cyperus brevifolius</em>,
    image: 'cyperus_brevifolius.png',
  },
  {
    id: 'bidens_pilosa',
    nombre: 'Bidens pilosa',
    nombreCientifico: <em>Bidens pilosa</em>,
    image: 'bidens_pilosa.png',
  },
  {
    id: 'drymaria_cordata_agresiva',
    nombre: 'Drymaria cordata',
    nombreCientifico: <em>Drymaria cordata</em>,
    image: 'drymaria_cordata_agresiva.png',
  },
  {
    id: 'solanum_americanum',
    nombre: 'Solanum americanum',
    nombreCientifico: <em>Solanum americanum</em>,
    image: 'solanum_americanum.png',
  },
  {
    id: 'talinum_paniculatum',
    nombre: 'Talinum paniculatum',
    nombreCientifico: <em>Talinum paniculatum</em>,
    image: 'talinum_paniculatum.png',
  },
];
  ...
  return (
    <div className="mt-3">
      <label className="block text-sm font-medium text-gray-700 mb-1">
        Fotos de la otra especie observada
      </label>
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-[1fr_160px] gap-2 items-center">
      <div className="flex items-center gap-2 flex-wrap">
        ...
        <button
          type="button"
          onClick={() => onOpenImage(arvense.image)}
      ...
      <input
        ...
        min="0"
        max="100"
        value={getValor(codigo, fieldKey)}
  ...
  return (
    <div className="mt-2 p-3 bg-gray-100 rounded border">
      <p className="text-sm font-medium text-gray-700 mb-2">
        Otra especie {tipo === 'noble' ? 'noble' : 'agresiva'}
      </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-[1fr_160px] gap-2 items-center">
        <input
          type="text"
          value={nombre}
          onChange={(e) => setValor(codigo, nombreKey, e.target.value)}
          className="border rounded px-2 py-1 w-full"
        ...
        <input
          ...
          min="0"
          max="100"
          value={getValor(codigo, porcentajeKey)}
          onChange={(e) => setValor(codigo, porcentajeKey, e.target.value)}
          className="border rounded px-2 py-1 w-full"
          placeholder="% cobertura"
        />
      </div>
...
export const ArvensesSection: React.FC<ArvensesSectionProps> = ({
  ...
  const handleZonaMonitoreadaChange = (
    codigo: string,
    zona: ZonaType,
    checked: boolean
  ) => {
    ...
    if (!checked) {
      ...
      campos.push(`${zona}_otra_especie_noble_nombre`);
      campos.push(`${zona}_otra_especie_noble_porcentaje`);
      campos.push(`${zona}_otra_especie_noble_fotos`);
      campos.push(`${zona}_otra_especie_agresiva_nombre`);
      campos.push(`${zona}_otra_especie_agresiva_porcentaje`);
      campos.push(`${zona}_otra_especie_agresiva_fotos`);
      ...
      <div className="mb-6 p-4 border rounded bg-gray-50">
          ...
          <div className="flex flex-col md:flex-row md:flex-wrap gap-3 md:gap-4">
            {['Hasta 20cm', 'De 20 a 50 cm', 'Mayor 50cm'].map((opcion) => (
              <label key={opcion} className="flex items-center">
                <input
                  type="radio"
                  name={`${codigo}_${zona}_altura`}
                  value={opcion}
                  checked={alturaActual === opcion}
                  onChange={(e) => handleAlturaChange(codigo, zona, e.target.value)}
                  className="mr-2"
                />
                {opcion}
              </label>
        ...
        <div className="mb-5">
          <h6 className="font-medium text-sm text-gray-700 mb-2">
            Arvenses Nobles y % de cobertura
          </h6>
          <p className="text-xs text-gray-500 mb-2">
          ...
          <div className="space-y-2">
            {ARVENSES_NOBLES.map((arvense) => (
              <ArvenseRow
                key={`${codigo}-${zona}-noble-${arvense.id}`}
                codigo={codigo}
                zona={zona}
                tipo="noble"
                arvense={arvense}
        ...
        <div className="mb-2">
          <h6 className="font-medium text-sm text-gray-700 mb-2">
            Arvenses Agresivas y % de cobertura
          </h6>
          <p className="text-xs text-gray-500 mb-2">
          ...
          <div className="space-y-2">
            {ARVENSES_AGRESIVAS.map((arvense) => (
              <ArvenseRow
                key={`${codigo}-${zona}-agresiva-${arvense.id}`}
                codigo={codigo}
                zona={zona}
                tipo="agresiva"
                arvense={arvense}
    ...
    <div className="bg-gray-50 p-6 rounded-lg shadow-md">
      ...
      <div className="mb-6 p-4 bg-white rounded-lg shadow-sm border">
        ...
        <ul className="list-disc list-inside text-sm text-gray-700 mt-2 ml-2">
          <li>
            <span className="font-medium">Lotes menores de 1 hectárea (&lt; 1 ha):</span>{' '}
            Recorrido en forma de X, cubriendo las diagonales del lote e incluyendo un punto central.
          </li>
          <li>
            <span className="font-medium">Lotes mayores de 1 hectárea (&gt; 1 ha):</span>{' '}
            Recorrido en forma de W, garantizando una mayor representatividad del área evaluada.
          </li>
        </ul>
        <p className="text-sm text-gray-700 mt-2">
          En cada punto de monitoreo se estimará visualmente el porcentaje de cobertura en{' '}
          <strong>platos</strong> (zona debajo de la gotera hacia el tronco) y{' '}
          <strong>calles</strong> (espacio entre hileras).
        </p>
      </div>
      ...
      {plantas.map((planta, index) => {
        ...
        return (
          <div key={codigo} className="border rounded-lg p-4 mb-8 bg-white shadow-sm">
              ...
              <div className="flex space-x-6">
                <label className="flex items-center">
                  <input
                    ...
                    checked={zonaPlato}
                    onChange={(e) =>
                      handleZonaMonitoreadaChange(codigo, 'plato', e.target.checked)
                    }
                    className="mr-2"
                  />
                  Platos
                ...
                <label className="flex items-center">
                  <input
                    ...
                    checked={zonaCalle}
                    onChange={(e) =>
                      handleZonaMonitoreadaChange(codigo, 'calle', e.target.checked)
                    }
                    className="mr-2"
                  />
                  Calles
            ...
            {/* Evaluación en PLATO */}
            {zonaPlato &&
              renderZona(codigo, 'plato', alturaPlato, (imageName) =>
                setModalImage(`/imgs/${imageName}`)
              )}

            {/* Evaluación en CALLE */}
            {zonaCalle &&
              renderZona(codigo, 'calle', alturaCalle, (imageName) =>
                setModalImage(`/imgs/${imageName}`)
              )}
      ...
      <div className="mt-6 p-4 bg-yellow-50 border-l-4 border-yellow-400 text-sm text-gray-700">
        ...
        <ul className="list-disc list-inside space-y-1">
          ...
          <li>
            En cada zona evaluada (plato y calle), clasifique la vegetación en arvenses nobles
            (baja capacidad competitiva) y arvenses agresivas (trepadoras, invasivas o altamente competitivas)
          </li>
